...
BackchannelTask* BackchannelTask::create_task(BackchannelBase& backchannel, backchannel_context_t& context, uint8_t priority, uint32_t core, uint32_t task_interval_microseconds)
{
    task_info_t task_info{};
    return create_task(task_info, backchannel, context, priority, core, task_interval_microseconds);
}

BackchannelTask* BackchannelTask::create_task(task_info_t& task_info, BackchannelBase& backchannel, backchannel_context_t& context, uint8_t priority, uint32_t core, uint32_t task_interval_microseconds)
{
    static BackchannelTask backchannel_task(task_interval_microseconds, backchannel, context);
